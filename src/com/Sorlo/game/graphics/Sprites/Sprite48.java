...
public class Sprite48 {
    ...
    public Sprite48(String file, int w, int h)
    {
        this.w=w;
        this.h=h;
    ...
    public Sprite48(BufferedImage buffImg) { //retine referinta catre BufferedImage object
        SPRITESHEET = buffImg;
    }
