...
public class Sprite16 {
    ...
    public BufferedImage Sprite(BufferedImage img)
    {
        w=TILE_SIZE;
        h=TILE_SIZE;
    ...
    public Sprite16(String file, int w, int h)
    {
        this.w=w;
        this.h=h;
    ...
    {
        spriteArray=new BufferedImage[1][1];

        spriteArray[0][0]=getSprite(0,0);
    ...
    public Sprite16(BufferedImage buffImg) { //retine referinta catre BufferedImage object
        SPRITESHEET = buffImg;
    }
