...
public class Sprite192 {

    private BufferedImage SPRITESHEET=null;
    private BufferedImage[][] spriteArray;
    private final int TILE_SIZE=192;
    public int w;
    public int h;
    private int wSprite;
    private int hSprite;
    ...
    public BufferedImage Sprite192(BufferedImage img)
    {
        w=TILE_SIZE;
        h=TILE_SIZE;
    ...
    public Sprite192(String file, int w, int h)
    {
        this.w=w;
        this.h=h;
    ...
    public Sprite192(BufferedImage buffImg) { //retine referinta catre BufferedImage object
        SPRITESHEET = buffImg;
    }
