...
public class Sprite64 {
    ...
    public BufferedImage Sprite80(BufferedImage img)
    {
        w=TILE_SIZE;
        h=TILE_SIZE;
    ...
    public Sprite64(String file, int w, int h)
    {
        this.w=w;
        this.h=h;
    ...
    public Sprite64(BufferedImage buffImg) { //retine referinta catre BufferedImage object
        SPRITESHEET = buffImg;
    }
