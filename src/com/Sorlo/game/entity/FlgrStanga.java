...
public class FlgrStanga extends Entity {
    ...
    public FlgrStanga(Sprite482 sprite, Vector2f origin, int size, PlayerNivel2 p) {

        super(sprite, origin, 48);
        sum=30;
    ...
    public void animate()
    {
            ...
            if (currentAnimation != 0 || ani.getDelay() == -1)
                setAnimation(0, sprite48.getSpriteArray(0), 5);//nu stim care e up, asa ca sounem ca 0 e UP, dar nu stim
