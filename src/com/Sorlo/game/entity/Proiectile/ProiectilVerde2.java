...
public class ProiectilVerde2 extends Entity {
    ...
    public ProiectilVerde2(Sprite32 sprite, Vector2f origin, int size, ENEM e) {
    ...
    public void render(Graphics2D g, int c) throws InterruptedException {
        if(pos.x<c) {
    ...
    public void render2(Graphics2D g, int c) throws InterruptedException {
        if(pos.x>c) {
            g.drawImage(ani.getImage(), (int) (pos.x), (int) (pos.y), size, size, null);
            pos.x -= dx;
            System.out.println("La Proiectil: " + pos.x);
