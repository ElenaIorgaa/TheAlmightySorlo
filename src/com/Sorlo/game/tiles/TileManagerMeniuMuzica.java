...
/**
 * Este clasa care va incarca Meniul de la optiunile pentru muzica
 */
public class TileManagerMeniuMuzica {
    ...
    public TileManagerMeniuMuzica(String path) {
        this();
        tm=new ArrayList<TileMap>();
